...
class DefectDetectionUI(QMainWindow):
    def __init__(self):
        ...
        try:
            self.cnn_model = tf.keras.models.load_model(r"C:\Users\Sourav Kumar\OneDrive\Desktop\Atanu's Major\defect_classification_model.keras")
        ...
        try:
            self.yolo_model = YOLO("runs/detect/Casting_defect/weights/best.pt")
